...
import 'الأحزاب_33.dart';
import 'فاطر_35.dart';

class O34 extends StatelessWidget {
  const O34({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Center(child: Text("سورة  سبأ ")),
        backgroundColor: mainColor,
      ),
      body: Container(
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text("السورة السابقة : سورة الأحزاب"),
                  ),
                ),
                Container(
                  width: double.infinity,
                  child: ElevatedButton(
                    ...
                    child: Text("السورة التالية : سورة فاطر "),
                  ),
                ),
              ],
            )
