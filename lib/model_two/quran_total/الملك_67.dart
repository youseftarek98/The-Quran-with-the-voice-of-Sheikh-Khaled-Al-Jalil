...
import 'القلم_68.dart';


class O67 extends StatelessWidget {
  const O67({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Center(child: Text("سورة  الملك ")),
        backgroundColor: mainColor,
      ),
      body: Container(
...
"""
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text("السورة السابقة : سورة التحريم"),
                  ),
                ),
                Container(
                  width: double.infinity,
                  child: ElevatedButton(
                    ...
                    child: Text("السورة التالية : سورة  القلم "),
                  ),
                ),
              ],
            )
