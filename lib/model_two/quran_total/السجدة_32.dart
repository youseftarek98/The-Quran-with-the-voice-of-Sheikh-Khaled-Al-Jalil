...
class O32 extends StatelessWidget {
  const O32({Key key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Center(child: Text("سورة  السجدة ")),
        backgroundColor: mainColor,
      ),
      body: Container(
...
"""                  , style: TextStyle(fontWeight: FontWeight.bold , fontSize: 20),
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text("السورة السابقة : سورة لقمان"),
                  ),
                ),
                Container(
                  width: double.infinity,
                  child: ElevatedButton(
                    ...
                    child: Text("السورة التالية : سورة   الأحزاب "),
                  ),
                ),
              ],
            )
