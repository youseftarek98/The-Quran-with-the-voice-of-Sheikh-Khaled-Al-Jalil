...
class DatabaseHelper {
  ...
  final String columnItemDescription = "itemDescription";
  ...
  void _onCreate(Database db, int version) async {
    await db.execute(
        "CREATE TABLE $tableTodoList($columnId INTEGER PRIMARY KEY, $columnItemName TEXT,$columnItemDescription TEXT, $columnDateCreated TEXT)");
  }
